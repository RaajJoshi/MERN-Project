            ...
            <div className='showHide'>
                ...
                {showHide && <div>
                    <table className='table'>
                        <tr><td>If you want to post complaint then register your self in <Link to='/reg'>Student Registration</Link></td></tr>
                        <tr><td>After registration Login to <Link to='/ulogin'>Student Login</Link></td></tr>
